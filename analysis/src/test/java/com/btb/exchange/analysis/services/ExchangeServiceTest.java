...
class ExchangeServiceTest {
    ...
    void transactionBuyFees() {
        ...
        assertThat(
                service.transactionBuyFees(BigDecimal.valueOf(100000)),
    ...
    void transactionSellFees() {
        ...
        var service = new ExchangeService(config);
        assertThat(
                service.transactionSellFees(BigDecimal.valueOf(100000)),
                is(closeTo(BigDecimal.valueOf(150), ERROR)));
    }
    ...
    void transportationFees() {
        ...
        var service = new ExchangeService(config);
        assertThat(
                service.transportationFees(CurrencyPair.BTC_USD),
                is(closeTo(BigDecimal.valueOf(5), ERROR)));
        assertThat(
                service.transportationFees(CurrencyPair.ETH_BTC),
                is(closeTo(BigDecimal.valueOf(4), ERROR)));
        assertThat(
                service.transportationFees(CurrencyPair.DASH_BTC),
