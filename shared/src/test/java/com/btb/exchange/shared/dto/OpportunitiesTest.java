...
class OpportunitiesTest {
    ...
    void serializeToJson() throws JsonProcessingException {
        var opportunity1 = new Opportunity(CurrencyPair.BTC_AUD, ExchangeEnum.KRAKEN, BigDecimal.valueOf(100), ExchangeEnum.BITFINEX, BigDecimal.valueOf(110), LocalTime.now());
        var opportunity2 = new Opportunity(CurrencyPair.ETH_BTC, ExchangeEnum.BITSTAMP, BigDecimal.valueOf(200), ExchangeEnum.COINBASE, BigDecimal.valueOf(210), LocalTime.now());
