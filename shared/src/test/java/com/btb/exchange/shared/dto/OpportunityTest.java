...
class OpportunityTest {
    ...
    void serializeToJson() throws JsonProcessingException, JSONException {
        ...
        var opportunity = new Opportunity(ExchangeEnum.KRAKEN, ExchangeEnum.BINANCE, CurrencyPair.BTC_AUD, BigDecimal.valueOf(100), BigDecimal.valueOf(110), now);
    ...
    void deserializeToJson() throws JsonProcessingException {
        ...
        var opportunity1 = new Opportunity(ExchangeEnum.KRAKEN, ExchangeEnum.BINANCE, CurrencyPair.BTC_AUD, BigDecimal.valueOf(100), BigDecimal.valueOf(110), now);
