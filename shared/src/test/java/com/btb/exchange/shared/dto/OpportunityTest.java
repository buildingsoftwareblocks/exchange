...
class OpportunityTest {
    ...
    void serializeToJson() throws JsonProcessingException, JSONException {
        ...
        var opportunity = new Opportunity(CurrencyPair.BTC_AUD, BigDecimal.ZERO, BigDecimal.valueOf(10), ExchangeEnum.KRAKEN, BigDecimal.valueOf(100), ExchangeEnum.BINANCE, BigDecimal.valueOf(110), now);
    ...
    void deserializeToJson() throws JsonProcessingException {
        ...
        var opportunity1 = new Opportunity(CurrencyPair.BTC_AUD, BigDecimal.ONE, BigDecimal.valueOf(10), ExchangeEnum.KRAKEN, BigDecimal.valueOf(100), ExchangeEnum.BINANCE, BigDecimal.valueOf(110), now);
